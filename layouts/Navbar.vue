                    ...
                    <el-form-item prop="phone">
                        ...
                        <div>
                            ...
                            <div style="text-align: center">
                                <el-checkbox
                                    style="margin-right: 0;margin-left: -50px;border-radius: 50%"
                                    @change="handleChange">
                                    登录即代表同意
                                </el-checkbox>
                ...
                info('').then(res => {
                    ...
                    phoneLogin(options).then(res => {
                        if (res.code === 100) {
                            ...
                            this.avatar_urls = localStorage.getItem('avatar_url')
                            history.go(0) // 刷新

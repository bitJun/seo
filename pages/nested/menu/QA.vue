              ...
              <div class="addkuang" style="padding: 20px;display: flex;margin-left: 2%;height: 165px;cursor:pointer;" @click="setdetail(item)" v-for="(item,index) in menulist" v-bind:key="index.url">
                ...
                <div style="height: 118px;line-height: 36px;width: 600px">
                  ...
                  <div style="display: flex;justify-content: space-between;width: 600px">
                    <div style="color: #BDBDBD;font-size: 12px"><img src="/images/icon/riqi.png" style="vertical-align: middle;margin-bottom: 2px;height: 12px;width: 12px"> {{ setTimedays(item.regdate) }}</div>
...
<style lang="scss" >
@import "../../../static/styles/nested/menu/QA.scss";
</style>

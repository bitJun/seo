              ...
              <el-tab-pane :label="item.cl_name" v-bind:key="item.cl_id" v-for="item in taglists">
                ...
                <div v-else>
                  <div class="orderthid" style="width: 1169px;margin: 1% auto;display: flex;flex-wrap: wrap;justify-content: space-between;margin-bottom: 100px">
                    <div class="hoverlist d1-1" style="display: inline-block;width: 32%;background: #ffffff;border-radius: 10px;;margin-bottom: 2%;" v-for="(item,index) in menulist" v-bind:key="index.url">
                      <!--线上课程-->
...
<style lang="scss" >
@import "../../static/styles/dashboard/calist.scss";
</style>

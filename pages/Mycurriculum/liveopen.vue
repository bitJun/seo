  ...
  <div style="display: flex;justify-content: space-between;width: 1199px;margin: 0 auto">
    ...
    <div style="width: 299px;height: 597px;">
      <div style="width: 100%;height: 160px;">
        ...
        <div id="wrap" style="width: 100%;height: 436px"></div>
      </div>
    </div>
  </div>
...
export default {
  ...
  created() {
    ...
    console.log('11111', this.nickname)
    console.log('11111', this.avatar_url)
    this.courseware_id = this.$route.query.channel_id
    this.setcurrculum()
    this.tuijian()
  },
  methods: {
...
<style lang="scss" >
@import "../../static/styles/Mycurriculum/liveopen.scss";
</style>

...
<div class="app-container">
  <div>
    <div class="curriculum_main" style="overflow: inherit;">
      <div id="page" class="top-bg">
        <div class="main">
          <!-- 关于犀鸟 -->
          <div class="about-tudou">
            <h3>法律声明</h3>
            <p><span style="font-size: 16px;">一、网络信息安全&nbsp;</span></p>
            <p><br></p>
            <p>&nbsp; &nbsp;
            ...
            <p><br></p>
            <p><span style="font-size: 16px;">二、知识产权声明</span></p>
            <p>&nbsp;</p>
            <p>&nbsp; &nbsp;
            ...
            <p><br></p>
            <p><span style="font-size: 16px;">三、隐私保护声明</span></p>
            <p>&nbsp; &nbsp;&nbsp;</p>
            <p>&nbsp; &nbsp; &nbsp;
            ...
            <p>2、运用Cookies技术，本网站能够为您提供更加周到的个性化服
...
<style lang="scss" >
@import "../../static/styles/movestudy/statement.scss";
</style>

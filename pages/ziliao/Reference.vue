...
<div id="Bklist" class="app-container">
  <div class="dashboard-font" style="width: 1169px;background: #ffffff;padding-top: 20px;border-radius: 10px;position: relative">
    <div style="padding: 1.5% 2%;position: absolute;right: 20px;top: 0;z-index: 9999">
      ...
      <img src="/images/icon/fangdajing.png" style="position: absolute;top: 30px;right: 40px;cursor:pointer;" @click="whatinputup">
    </div>
    <el-tabs v-model="activeNames">
      <el-tab-pane label="招考公告" name="first" :key="'first'">
        <div class="dashboard-font" id="addthis">
          <el-tabs v-model="activeName" @tab-click="handleClick">
            <el-tab-pane :label="item.title" v-bind:key="item.id" v-for="item in plates"></el-tab-pane>
          </el-tabs>
          <el-tabs v-model="activeName" @tab-click="handleClick">
                ...
                <div style="display: flex;justify-content: space-between;padding: 1% 0 1% 1%">
                  <div>
                    <div class="addkuang" style="padding: 20px;display: flex;margin-left: 2%;height: 135px;cursor:pointer;" @click="setdetail(item)" v-for="(item,index) in menulist" v-bind:key="index.url">
                      ...
                      <div style="width: 161px;height: 86px;margin-right: 10px">
                  ...
                  <div style="margin-right: 20px;margin-top: 22px">
                    <div v-for="(item,index) in bannerimg" v-bind:key="index.url">
                      <div style="width: 299px">
                        <img :src="item.img_url" alt="" @click="setdetails(index,item)" style="width: 100%;margin-bottom: 20px;border-radius: 6px">
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <el-tab-pane label="备考资料" name="second" :key="'second'">
        <div class="dashboard-font" id="addthis">
          <el-tabs v-model="activeName" @tab-click="handleClick">
            <el-tab-pane :label="item.title" v-bind:key="item.id" v-for="item in plates">
              <div style="width: 1169px;height: auto;margin:auto;background: #ffffff">
      ...
      <el-tab-pane label="真题下载" name="third" :key="'third'">
        <div class="dashboard-font" id="addthis">
          <el-tabs v-model="activeName" @tab-click="handleClick">
            <el-tab-pane :label="item.title" v-bind:key="item.id" v-for="item in plates"></el-tab-pane>
          </el-tabs>
...
<style lang="scss">
@import "../../static/styles/nested/menu/Reference.scss";
</style>
